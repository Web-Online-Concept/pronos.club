...
/**
 * ═══════════════════════════════════════════════════════════════════
 * Composant client : BilanHebdoCharts
 * ═══════════════════════════════════════════════════════════════════
 *
 * Affiche les 4 graphiques recharts du bilan hebdo :
 ...
 *
 * Path : src/components/bilan/BilanHebdoCharts.tsx
 * ═══════════════════════════════════════════════════════════════════
 */
...
export function BilanHebdoCharts({ bilan }: Props) {
  // ─── Data prep
  ...
  const tierOrder: Array<keyof BilanHebdo["picks_by_tier"]> = [
    "lock",
    "strong",
    "value",
    "coup_de_coeur",
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-6">
        ...
        <p className="text-sm text-zinc-500 mb-6">
          Profit cumulé jour par jour sur la semaine
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-6">
          ...
          <p className="text-sm text-zinc-500 mb-6">
            Sur {stakedTotal + bilan.picks_void} picks de la semaine
          </p>
          ...
          <div className="h-64 w-full">
            {tierData.length === 0 ? (
              <div className="h-full flex items-center justify-center text-zinc-400 text-sm">
                Aucune catégorie active cette semaine
              </div>
            ) : (
              <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-6">
        ...
        >
          {sportData.length === 0 ? (
            <div className="h-full flex items-center justify-center text-zinc-400 text-sm">
              Aucune donnée sport cette semaine
            </div>
          ) : (
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
