...
export const SPORTS_CONFIG: SportConfig[] = [
  {
    ...
    leagues: [
      ...
      { slug: "sui.1", name: "Super League", flag: "🇨🇭", priority: 22 },
      { slug: "aut.1", name: "Bundesliga AT", flag: "🇦🇹", priority: 23 },
      { slug: "gre.1", name: "Super League GR", flag: "🇬🇷", priority: 24 },
      { slug: "den.1", name: "Superliga", flag: "🇩🇰", priority: 25 },
      { slug: "nor.1", name: "Eliteserien", flag: "🇳🇴", priority: 26 },
      { slug: "swe.1", name: "Allsvenskan", flag: "🇸🇪", priority: 27 },
      { slug: "pol.1", name: "Ekstraklasa", flag: "🇵🇱", priority: 28 },
    ],
  },
  {
    key: "tennis",
