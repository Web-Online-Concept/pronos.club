...
export const SPORTS_CONFIG: SportConfig[] = [
  {
    ...
    leagues: [
      ...
      { slug: "ned.1", name: "Eredivisie", flag: "🇳🇱", priority: 9 },
      { slug: "por.1", name: "Liga Portugal", flag: "🇵🇹", priority: 10 },
      { slug: "tur.1", name: "Süper Lig", flag: "🇹🇷", priority: 11 },
      { slug: "bel.1", name: "Pro League", flag: "🇧🇪", priority: 12 },
      { slug: "usa.1", name: "MLS", flag: "🇺🇸", priority: 13 },
      { slug: "bra.1", name: "Brasileirão", flag: "🇧🇷", priority: 14 },
