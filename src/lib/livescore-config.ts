...
export const SPORTS_CONFIG: SportConfig[] = [
  {
    ...
    leagues: [
      ...
      { slug: "rus.1", name: "Premier League RU", flag: "ru", country: "RUSSIE", priority: 29 },
      { slug: "cyp.1", name: "First Division", flag: "cy", country: "CHYPRE", priority: 30 },
      { slug: "irl.1", name: "Premier Division", flag: "ie", country: "IRLANDE", priority: 31 },
      { slug: "col.1", name: "Liga BetPlay", flag: "co", country: "COLOMBIE", priority: 32 },
      { slug: "chi.1", name: "Primera División", flag: "cl", country: "CHILI", priority: 33 },
      { slug: "per.1", name: "Liga 1", flag: "pe", country: "PÉROU", priority: 34 },
      { slug: "ecu.1", name: "Liga Pro", flag: "ec", country: "ÉQUATEUR", priority: 35 },
      { slug: "uru.1", name: "Primera División", flag: "uy", country: "URUGUAY", priority: 36 },
      { slug: "par.1", name: "División de Honor", flag: "py", country: "PARAGUAY", priority: 37 },
      { slug: "chn.1", name: "Chinese Super League", flag: "cn", country: "CHINE", priority: 38 },
      { slug: "ind.1", name: "Indian Super League", flag: "in", country: "INDE", priority: 39 },
      { slug: "ksa.1", name: "Saudi Pro League", flag: "sa", country: "ARABIE SAOUDITE", priority: 40 },
      { slug: "rsa.1", name: "Betway Premiership", flag: "za", country: "AFRIQUE DU SUD", priority: 41 },
    ],
  },
  {
    key: "tennis",
