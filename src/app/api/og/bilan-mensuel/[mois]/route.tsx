/**
 * ═══════════════════════════════════════════════════════════════════
 * /api/og/bilan-mensuel/[mois] — OG image bilan mensuel
 * ═══════════════════════════════════════════════════════════════════
 *
 * Image OG dynamique pour partage Telegram/X/WhatsApp d'un bilan mensuel.
 * Format 1200x630.
 *
 * Look impact : gradient violet/fuchsia + ROI géant en couleur (vert si
 * positif, rouge si négatif) + V/D/N + winrate + logo.
 *
 * Path : src/app/api/og/bilan-mensuel/[mois]/route.tsx
 * ═══════════════════════════════════════════════════════════════════
 */
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* HEADER : badge BILAN MENSUEL + logo */}
        <div
          style={{
            display: "flex",
            alignItems: "center",
