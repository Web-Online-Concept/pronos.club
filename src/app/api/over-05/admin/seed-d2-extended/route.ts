// src/app/api/over-05/admin/seed-d2-extended/route.ts
//
// POST /api/over-05/admin/seed-d2-extended
//
// Route admin pour seeder les PROJETS des 6 derniers championnats :
//   - La Liga 2 (DB 8, API 141)
//   - 2. Bundesliga (DB 9, API 79)
//   - Eredivisie (DB 11, API 88)
//   - Liga Portugal (DB 12, API 94)
//   - Pro League Belgique (DB 13, API 144)
//   - Süper Lig Turquie (DB 14, API 203)
//
// Memes seuils de categorisation auto que pour les autres D2.
...
const LEAGUES_TO_SEED = [
  { db_id: 8,  api_football_id: 141, name: "La Liga 2" },
  { db_id: 9,  api_football_id: 79,  name: "2. Bundesliga" },
  { db_id: 11, api_football_id: 88,  name: "Eredivisie" },
  { db_id: 12, api_football_id: 94,  name: "Liga Portugal" },
  { db_id: 13, api_football_id: 144, name: "Pro League" },
  { db_id: 14, api_football_id: 203, name: "Süper Lig" },
];
...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    info: "POST cette route pour seeder les 6 derniers championnats",
