...
export default function MesStatsPage() {
  ...
  // User bankroll — for euro display
  ...
  return (
    ...
    <main className="mx-auto max-w-5xl px-4 pb-8">
      ...
      {/* Bankroll summary — if configured */}
      {showEuro && bkConfig && userUnitValue > 0 && (
        <div className="mt-4 flex flex-wrap items-center justify-center gap-4 rounded-xl bg-white/5 px-5 py-3">
          <span className="text-xs text-neutral-400">Bankroll : <span className="font-bold text-neutral-800">{bkConfig.current_bankroll.toLocaleString("fr-FR")}€</span></span>
          <span className="text-xs text-neutral-400">1U = <span className="font-bold text-emerald-600">{userUnitValue.toFixed(2)}€</span></span>
          <span className="text-xs text-neutral-400">Mode : <span className="font-semibold text-neutral-600">{bkConfig.mode === "fixed_unit" ? "Mise fixe" : "% de BK"}</span></span>
        </div>
      )}
        ...
        <>
          ...
          <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
            <div className="relative overflow-hidden rounded-2xl p-5 text-center" style={{ background: "linear-gradient(135deg, #0a0a0a 0%, #062e1f 100%)" }}>
              <p className="text-3xl font-extrabold text-white">{o.totalFollowed}</p>
            ...
            <div className="relative overflow-hidden rounded-2xl p-5 text-center" style={{ background: "linear-gradient(135deg, #0a0a0a 0%, #062e1f 100%)" }}>
              <p className={`text-3xl font-extrabold ${o.profit >= 0 ? "text-emerald-400" : "text-red-400"}`}>{o.profit >= 0 ? "+" : ""}{displayVal(o.profit)}</p>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
            <div className="group relative overflow-hidden rounded-2xl border border-neutral-100 bg-white p-4 text-center shadow-sm transition hover:shadow-md">
              ...
              <p className="mt-1 text-2xl font-extrabold text-emerald-600">{o.won}</p>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-neutral-100 bg-white p-4 text-center shadow-sm transition hover:shadow-md">
              ...
              <p className="mt-1 text-2xl font-extrabold text-red-500">{o.lost}</p>
          ...
          <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-neutral-100 bg-white p-4 text-center shadow-sm transition hover:shadow-md">
              ...
              <p className="mt-1 text-2xl font-extrabold text-neutral-900">{displayVal(o.staked)}</p>
          ...
          <section className="mt-16">
            <div
              className="-mx-4 border-y border-emerald-700/50 px-4 py-6 sm:-mx-[calc((100vw-64rem)/2+1rem)] sm:px-[calc((100vw-64rem)/2+1rem)]"
            ...
            <div className="mt-4 h-72 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={isEuroMode ? data.profitTimeline.map((p) => ({ ...p, profit: Math.round(p.profit * userUnitValue * 100) / 100 })) : data.profitTimeline}>
          ...
          {data.byMonth.length > 1 && (
            ...
            >
              ...
              <div className="mt-4 h-64 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={isEuroMode ? data.byMonth.map((m) => ({ ...m, profit: Math.round(m.profit * userUnitValue * 100) / 100 })) : data.byMonth}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
            ...
            <div className="mt-4 h-64">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    data={[
                      { name: "Gagnés", value: o.won },
                      { name: "Perdus", value: o.lost },
