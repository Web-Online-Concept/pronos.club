...
export default function MonHistoriquePage() {
  ...
  // Shared select class — max-w-[110px] on mobile forces compact look
  const selectClass = "max-w-[110px] cursor-pointer truncate rounded-full border border-neutral-200 bg-white px-2.5 py-1.5 text-[11px] font-semibold sm:max-w-none sm:px-4 sm:py-2 sm:text-xs";
