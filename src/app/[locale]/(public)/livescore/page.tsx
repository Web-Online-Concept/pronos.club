...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const ogImage = `https://pronos.club/api/og?title=${encodeURIComponent("Livescore")}&subtitle=${encodeURIComponent("Scores en direct - Tous les sports")}&cover=${encodeURIComponent("/og/livescore.png")}`;
