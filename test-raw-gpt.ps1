...
$r = Invoke-WebRequest -Uri "https://www.pronos.club/api/debug/ai-consensus-test?mode=raw-gpt" -Headers $headers -UseBasicParsing -TimeoutSec 180
$content = $r.Content
...
Write-Host ""
Write-Host "=== RAW RESPONSE GPT (les 2000 premiers chars) ==="
